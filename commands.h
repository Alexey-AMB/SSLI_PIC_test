...
typedef enum {          //длинна данных, описание
    ...
    CMD_SET_UPDATES,    //2, передача статуса обмена обносвлениями слот, статус: (0 - готов к передаче, 1 - передача завершена, 3 - передача завершена и перезагрузка)
    CMD_USB_OE_EN,      //1, включить канал USB - параметр номер слота
    CMD_USB_OE_DIS      //1, полность выключить USB (и top и bottom) - параметр номер слота
} UsartCommand;
